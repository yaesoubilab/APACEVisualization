...
# ---- settings ----
POLICY_PARAMS = [3.5096096195, -0.80157278249, 0.23164372] # [5,-1,0.25] # [5.0096096195,-1.0157278249,0.0033164372]
WTPS = np.linspace(0.5e5, 1.5e5, 9)  # [min, max, number of points]
