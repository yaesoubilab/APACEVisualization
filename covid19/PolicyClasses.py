...
class PolicySingleFeature:
    ...
    def add_policy_figure_when_relaxed(self, ax, y_label, max_feature_value, wtp_range, wtp_delta,
        ...
        self.add_plot_to_axis(ax=ax,
                              ys=self.OnTs,
                              reg=self.RegToOn,
                              title="Decision criteria when\nphysical distancing is off",
                              text_turn_off='Keep physical\ndistancing off',
                              text_turn_on='Switch physical\ndistancing on',
                              panel_label='A)',
    ...
    def add_policy_figure_when_tightened(self, ax, max_feature_value, wtp_range, wtp_delta,
        ...
        self.add_plot_to_axis(ax=ax,
                              ys=self.OffTs,
                              reg=self.RegToOff,
                              title="Decision criteria when\nphysical distancing is on",
                              text_turn_off="Switch physical\ndistancing off",
                              text_turn_on="Keep physical\ndistancing on",
                              panel_label='B)',
                              max_feature_value=max_feature_value,
                              wtp_range=wtp_range,
                              wtp_delta=wtp_delta,
